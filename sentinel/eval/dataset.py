...
def seed_dataset() -> list[Case]:
    ...
    cases += [
        Case(
            ...
            {
                "visual_total": 400,
                "structured_total": 6000,  # 15x -> solo hit
                "tone_anomaly": 0.5,
                "domain_age_days": 40,
            },
            "Blatant 15x total mismatch.",
            family="obvious_fraud",
        ),
        Case(
            "C-4502",
            1,
            ...
            "Brand-new 1-day-old sender domain.",
            family="obvious_fraud",
        ),
        Case(
            "C-4503",
            ...
            {
                "visual_total": 2000,
                "structured_total": 2000,
                "injection_present": True,  # injection -> solo hit
            },
            "Embedded prompt-injection attempt in the document.",
            family="obvious_fraud",
        ),
        Case(
            "C-4504",
            ...
            {
                "voice_mismatch": 0.95,
                "domain_age_days": 60,  # extreme voice -> solo hit
            },
            "Extreme voice-spoof score.",
            family="obvious_fraud",
        ),
    ]
    ...
    cases += [
        Case(
            ...
            {
                "visual_total": 3200,
                "structured_total": 3200,
                "tone_anomaly": 0.1,
                "domain_age_days": 1400,
            },
            "Established vendor, totals match, normal tone.",
            family="clean",
        ),
        Case(
            "C-5002",
            ...
            {
                "visual_total": 750,
                "structured_total": 750,
                "tone_anomaly": 0.2,
                "domain_age_days": 900,
            },
            "Routine small invoice.",
            family="clean",
        ),
        Case(
            "C-5003",
            ...
            "Genuine voice note from a known colleague.",
            family="clean",
        ),
    ]
    ...
    cases += [
        Case(
            ...
            {
                "visual_total": 12000,
                "structured_total": 12000,  # totals MATCH
                "tone_anomaly": 0.35,
                "domain_age_days": 20,  # young domain + urgent
            },
